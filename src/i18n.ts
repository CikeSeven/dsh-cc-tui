...
const dict = {
  ...
  // ── tui/components/settings-panel.ts (/settings，即改即存底部面板) ──
  ...
  'settings-value-on': { zh: '开', en: 'on' },
  'settings-value-off': { zh: '关', en: 'off' },
  'settings-no-matches': { zh: '没有匹配的设置项', en: 'No matching settings' },
  'settings-hint-panel': { zh: '↑↓ 选择 · Enter/Space 切换/进入 · 输入即搜索 · Esc 关闭', en: '↑↓ navigate · Enter/Space change/open · type to search · Esc close' },
