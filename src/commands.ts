...
export const LOCAL_COMMANDS: LocalCommand[] = [
  ...
  { name: 'effort', description: 'Select the reasoning effort level' },
  ...
  { name: 'permission', description: 'Select the session permission mode' },
  ...
  { name: 'reload', description: 'Reload the TUI in place (session preserved)' },
