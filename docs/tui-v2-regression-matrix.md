  ...
  "rows": [
    {
      ...
      "traceId": "tui-v2-benchmark@v2",
      "assertion": "v2 benchmark: coordinator startup/stop、stream frame latency、VirtualTerminal grid hash、身份字段与 --expose-gc fail-fast",
      "ciCommand": "pnpm bench:tui-v2 (node --expose-gc --import tsx/esm scripts/bench-tui-v2.ts)",
      "blockDefault": false,
      "deleteCondition": "v2 benchmark 入口原样保留；仅在 benchmark schema 被替代时删除",
    ...
    },
    {
      ...
      "assertion": "v2 input/command controllers cover Ctrl+C clear/arm/exit, Ctrl+D two-press exit, /exit|/quit|/q coordinator callback, and stop-reason forwarding; real PTY host execution remains a stage-3/manual gate",
    ...
    },
    {
      ...
      "owner": "tui-v2",
      "status": "verified",
      "updatedAt": "2026-08-20T15:46:22.000Z",
      "traceId": "settings-routing@v1",
      "assertion": "canonical grid: v2 /model picker 仅调用一次现有原子 switchModel(provider, model)，adapter identity-compatible wakeup 不新增 rows-reset 或重复 startup/welcome 行，fullscreen/inline owner 生命周期均有覆盖",
    ...
    },
    {
      ...
      "updatedAt": "2026-08-20T15:46:22.000Z",
      "traceId": "settings-routing@v1",
      "assertion": "canonical grid: v2 /settings 通过 SettingsHost/SettingsForm capability 完成 section/field 导航、四类 staged 编辑、validation、revision conflict retry、reload/reset 与 dirty Esc confirm；100-cell 双栏及恶意控制序列宽度安全",
    ...
    },
    {
      ...
      "status": "verified",
      "updatedAt": "2026-08-21T00:00:00.000Z",
      "traceId": "smoke-coordinator-startup@v2",
      "assertion": "v2 smoke: createTuiV2App/coordinator 首帧、注入 VirtualTerminal frame、输入行与 stop/terminal restore",
      "ciCommand": "pnpm smoke (node --import tsx/esm scripts/smoke-tui-v2.mjs)",
      "blockDefault": false,
      "deleteCondition": "v2 smoke 入口原样保留；仅在生产 bootstrap contract 被替代时删除",
      "disposition": "unaffected"
    },
    {
      "id": "REG-023",
    ...
    },
    {
      ...
      "updatedAt": "2026-08-20T15:46:22.000Z",
      "traceId": "settings-routing@v1",
      "assertion": "canonical grid: v2 /effort 分段 slider 支持左右、Tab/Backtab、数字快捷键与实时 setEffort；pending/error 后从 Channel 实际 reasoningEffort 回读并投影到状态栏，窄宽不越界",
    ...
    },
    {
      ...
      "assertion": "domain projection: reasoning/tool-only assistant steps create no empty assistant row before entering the v2 adapter/render pipeline",
      "ciCommand": "node scripts/verify-empty-assistant-row.mjs",
      "blockDefault": false,
      "deleteCondition": "renderer-neutral channel projection gate remains until the projection contract is replaced",
      "disposition": "unaffected"
    },
    {
      "id": "REG-040",
    ...
    },
    {
      ...
      "owner": "tui-v2",
      "status": "verified",
      "updatedAt": "2026-08-20T13:52:28.000Z",
      "traceId": "session-workspace@v1",
      "assertion": "width: v2 session/workspace overlay 在 0/1/2/20/99/100/140 列、CJK/emoji/ZWJ/组合字符/恶意 ANSI/OSC 下逐行不超宽，99 列 preview 单栏替换、100 列 list+preview 分栏",
    ...
    },
    {
      ...
      "updatedAt": "2026-08-20T13:52:28.000Z",
      "traceId": "session-workspace@v1",
      "assertion": "input: v2 session browser 覆盖 code-point 搜索、项目/分支/subagent 切换、循环与分页导航、preview、resume 失败留窗、Ctrl+D+plain Enter 删除确认、rename 按 id 保焦点、Esc 分层关闭及 late-result 失效",
    ...
    },
    {
      ...
      "updatedAt": "2026-08-20T13:52:28.000Z",
      "traceId": "session-workspace@v1",
      "assertion": "canonical grid: v2 复用 sessions/view 的 root/fork/subagent lineage 与 kind 真值，project/session 变高行按 16 physical-line budget 窗口化，选中项保持在可见窗口且 payload/parser 有界",
    ...
    },
    {
      ...
      "updatedAt": "2026-08-21T14:45:00.000Z",
      "traceId": "external-editor-tty-handoff@v1",
      "assertion": "v2 fake-stream takeover suspend/resume preserves writer ownership, terminal modes, input generation and cleanup; a real PTY editor process remains a manual/stage-3 gate",
    ...
    },
    {
      ...
      "assertion": "production plugin has one v2 bootstrap, structural stores/status/shortcut/scene seams, profile resolver, coordinator-owned stop reasons and no React/Chat/Ink imports; real launcher/PTY execution remains stage 3",
