/**
 * pi fork: ported from pi packages/tui/test/select-list.test.ts
...
import { SelectList } from "../../../src/tui-v2/vendor/pi-tui/src/components/select-list.js";
