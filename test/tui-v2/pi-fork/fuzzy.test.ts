/**
 * pi fork: ported from pi packages/tui/test/fuzzy.test.ts
...
import { fuzzyFilter, fuzzyMatch } from "../../../src/tui-v2/vendor/pi-tui/src/fuzzy.js";

describe("pi fork: fuzzyMatch", () => {
