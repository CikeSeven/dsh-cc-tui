/**
 * pi fork: ported from pi packages/tui/test/terminal-image.test.ts
 ...
 * this file.
 * Local adaptations:
 *   - dropped 3 test(s) using the excluded Image component: caps Image component height to a square pixel box by default; places image sequence on first line with empty padding rows; truncates long image fallback lines to render width
 */
/**
...
describe("pi fork: detectCapabilities", () => {
...
describe("pi fork: iTerm2 image encoding", () => {
...
describe("pi fork: Kitty image cursor movement", () => {
...
describe("pi fork: imageFallback", () => {
