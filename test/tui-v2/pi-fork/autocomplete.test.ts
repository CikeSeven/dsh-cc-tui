/**
 * pi fork: ported from pi packages/tui/test/autocomplete.test.ts
...
import { CombinedAutocompleteProvider } from "../../../src/tui-v2/vendor/pi-tui/src/autocomplete.js";
...
describe("pi fork: CombinedAutocompleteProvider", () => {
