/**
 * pi fork: ported from pi packages/tui/test/truncate-to-width.test.ts
...
import { normalizeTerminalOutput, truncateToWidth, visibleWidth } from "../../../src/tui-v2/vendor/pi-tui/src/utils.js";

describe("pi fork: truncateToWidth", () => {
