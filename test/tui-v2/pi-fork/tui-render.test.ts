/**
 * pi fork: ported from pi packages/tui/test/tui-render.test.ts
 ...
 * this file.
 * Local adaptations:
 *   - dropped 4 test(s) using the excluded Image component: clears reserved Kitty image rows before drawing appended image placements; falls back to full redraw when Kitty image pre-clear would scroll; reserves Kitty image rows before drawing during full redraw fallbacks; does not use cursor-up placement for Kitty images taller than the viewport
 */
...
describe("pi fork: TUI render scheduling", () => {
...
describe("pi fork: TUI debug logging", () => {
...
describe("pi fork: TUI Kitty image cleanup", () => {
...
describe("pi fork: TUI resize handling", () => {
...
describe("pi fork: TUI content shrinkage", () => {
...
describe("pi fork: TUI differential rendering", () => {
