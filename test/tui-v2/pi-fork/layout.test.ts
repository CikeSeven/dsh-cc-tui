/**
 * pi fork: ported from pi packages/tui/test/layout.test.ts
...
import { renderLayoutFrame } from "../../../src/tui-v2/vendor/pi-tui/src/layout.js";
import { encodeKitty, registerKittyImageMetadata } from "../../../src/tui-v2/vendor/pi-tui/src/terminal-image.js";
import { stripTerminalSequences } from "../../../src/tui-v2/vendor/pi-tui/src/utils.js";

function visibleLines(lines: string[]): string[] {
	return lines.map((line) => stripTerminalSequences(line).trimEnd());
}

describe("pi fork: viewport layout", () => {
