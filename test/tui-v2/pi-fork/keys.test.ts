/**
 * pi fork: ported from pi packages/tui/test/keys.test.ts
...
} from "../../../src/tui-v2/vendor/pi-tui/src/keys.js";
...
describe("pi fork: decodeKittyPrintable", () => {
...
describe("pi fork: decodePrintableKey", () => {
