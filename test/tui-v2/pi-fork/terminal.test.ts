/**
 * pi fork: ported from pi packages/tui/test/terminal.test.ts
...
import { setKittyProtocolActive } from "../../../src/tui-v2/vendor/pi-tui/src/keys.js";
import {
	normalizeAppleTerminalInput,
	normalizeNativeShiftEnterInput,
	ProcessTerminal,
	resolveEscapeTimeoutMs,
} from "../../../src/tui-v2/vendor/pi-tui/src/terminal.js";

describe("pi fork: resolveEscapeTimeoutMs", () => {
...
describe("pi fork: normalizeNativeShiftEnterInput", () => {
...
describe("pi fork: normalizeAppleTerminalInput", () => {
...
describe("pi fork: ProcessTerminal Kitty keyboard protocol negotiation", () => {
...
describe("pi fork: ProcessTerminal progress", () => {
...
describe("pi fork: ProcessTerminal dimensions", () => {
