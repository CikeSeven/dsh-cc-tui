/**
 * pi fork: ported from pi packages/tui/test/tab-width.test.ts
...
import { extractSegments, normalizeTerminalOutput, sliceWithWidth, visibleWidth } from "../../../src/tui-v2/vendor/pi-tui/src/utils.js";
...
describe("pi fork: tab width accounting", () => {
