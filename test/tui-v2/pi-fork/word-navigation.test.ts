/**
 * pi fork: ported from pi packages/tui/test/word-navigation.test.ts
...
import { findWordBackward, findWordForward } from "../../../src/tui-v2/vendor/pi-tui/src/word-navigation.js";

describe("pi fork: findWordBackward", () => {
...
describe("pi fork: findWordForward", () => {
	it("basic words: hello world", () => {
		const text = "hello world";
...
describe("pi fork: atomic segments", () => {
