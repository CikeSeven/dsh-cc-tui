 ...
 * lifecycle, rowId encoding, immutability, and the 21-trace replay corpus
...
test('model replay: all 21 corpus traces reduce deterministically (replay)', async () => {
  const traces = await loadTraces()
  assert.equal(traces.length, 21)
