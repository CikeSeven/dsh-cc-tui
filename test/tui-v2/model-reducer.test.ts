 ...
 * lifecycle, rowId encoding, immutability, and the 19-trace replay corpus
...
test('model replay: all 19 corpus traces reduce deterministically (replay)', async () => {
  const traces = await loadTraces()
  assert.equal(traces.length, 19)
